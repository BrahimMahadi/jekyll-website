...
<div class="well">
	...
	<div class="well mrgn-tp-md mrgn-bttm-md text-nowrap" style="width: 8rem; border: 2px solid black">
		<h4 class="mrgn-tp-md">No wrap</h4>
		<p>Lorem ipsum dolor sit amet, consectetur adipiscing elit.</p>
	</div>
</div>
<h4>Code sample</h4>
